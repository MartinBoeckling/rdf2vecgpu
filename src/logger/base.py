...
class BaseTracker:
    ...
    def start_pipeline(self, run_name: Optional[str], tags: Optional[Dict[str, str]] = None) -> None: return self

    @contextmanager
    def stage(self, name: str): yield self
    ...
    def log_figure(self, figure: Any, artifact_path: str): pass
    def close(self): pass
    def log_model_pytorch(self, model, artifact_path:str): pass